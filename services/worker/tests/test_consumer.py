...
def test_video_render_timeout_defaults_to_240_seconds():
    # The real ffmpeg render for a 3-scene 1080x1920 video has been measured
    # at ~80.6s-136.2s (CPU-only libx264 encoding) depending on content;
    # 120s was too tight for the higher end. 240s gives comfortable margin.
    assert Settings().video_render_timeout_seconds == 240
